...
export function ExportScreen({ onComplete }: ExportScreenProps) {
  ...
  const handleExport = async () => {
    ...
    // In a real app, this would generate and download the files
    alert(`Exported ${selectedExports.length} formats successfully!`);
  };
