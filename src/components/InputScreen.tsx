...
import { ImagePlus, Mic, Upload, ArrowRight, Pause, Play, Square, Send, Headphones, CheckCircle, Camera } from 'lucide-react';
        ...
        <Card className="border-2 border-dashed border-primary/30 hover:border-primary/50 transition-colors">
          ...
          <CardContent className="space-y-4">
            ...
            <Input
              ...
              className="hidden"
            />
            {/* FIX: use native input so capture works */}
            <input
              type="file"
              accept="image/*"
              capture="environment"
